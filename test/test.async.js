...
describe( 'async', function tests() {
	...
	it( 'should create a TODO.md file in a specified directory', function test( done ) {
		var dirpath;
		...
		function onFinish( error ) {
			...
			if ( error ) {
				...
				bool = fs.existsSync( path.join( dirpath, 'TODO.md' ) );
	...
	it( 'should create a TODO.md file in a specified directory without requiring a callback', function test( done ) {
		var dirpath;
		...
		function onTimeout() {
			var bool = fs.existsSync( path.join( dirpath, 'TODO.md' ) );
	...
	it( 'should create a TODO.md file using a specified template', function test( done ) {
		var dirpath;
		...
		function onFinish( error ) {
			...
			fpath1 = path.join( dirpath, 'TODO.md' );
			f1 = fs.readFileSync( fpath1, {
				'encoding': 'utf8'
			});

			fpath2 = path.join( path.resolve( __dirname, '../lib/default' ), 'TODO.md' );
