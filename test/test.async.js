...
describe( 'async', function tests() {
	...
	it( 'should create a TODO.md file in a specified directory', function test() {
		var dirpath;
	...
	it( 'should create a TODO.md file in a specified directory without requiring a callback', function test() {
		var dirpath;
	...
	it( 'should create a TODO.md file using a specified template', function test() {
		var dirpath;
