...
*	Asynchronously creates a TODO file.
*
* @param {String} dest - TODO destination directory
* @param {Object} [opts] - function options
* @param {String} [opts.template="default"] - TODO template to use
* @param {Function} [clbk] - callback to invoke upon attempting to create a TODO file
*/
function cp() {
	var args = arguments,
		nargs = args.length,
	...
	fpath = path.join( __dirname, tmpl, 'TODO.md' );
	dpath = path.join( dest, 'TODO.md' );
